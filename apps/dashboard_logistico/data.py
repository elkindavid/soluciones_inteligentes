...
def fetch_logistico(tipo=None, desde=None, hasta=None, pedido=None, origen=None, destino=None, transportadora=None, material=None, placa=None, 
    proveedor_mat=None, transporte=None):
    """
